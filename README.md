...
> New to HTTP? See [THEORY.md](./THEORY.md) for background. This README focuses on what I built, how I built it and explains the decisions along the way.
